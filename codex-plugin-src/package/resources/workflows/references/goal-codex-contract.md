...
- Load a check method only through an explicit Markdown reference from the
  relevant internal workflow. Do not expose package-relative check paths as
  project-cwd commands and never resolve a source checkout as runtime fallback.
