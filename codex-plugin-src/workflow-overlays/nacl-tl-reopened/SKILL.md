...
[`the packaged reopened-drain proof method`](../../nacl-goal/checks/reopened-drain.sh)
as an internal reference only; it is not a project-cwd command. GOAL_PROOF is
