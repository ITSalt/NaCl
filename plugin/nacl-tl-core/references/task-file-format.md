...
**Created By**: `nacl-tl-plan` | **Read By**: `nacl-tl-dev-be` | **Template**: `$(nacl-home)/nacl-tl-core/templates/task-be-template.md`
...
**Created By**: `nacl-tl-plan` | **Read By**: `nacl-tl-dev-fe` | **Template**: `$(nacl-home)/nacl-tl-core/templates/task-fe-template.md`
...
**Created By**: `nacl-tl-plan` | **Read By**: `nacl-tl-dev-be` (RED phase) | **Template**: `$(nacl-home)/nacl-tl-core/templates/test-spec-template.md`
...
**Created By**: `nacl-tl-plan` | **Read By**: `nacl-tl-dev-fe` (RED phase) | **Template**: `$(nacl-home)/nacl-tl-core/templates/test-spec-fe-template.md`
...
**Created By**: `nacl-tl-plan` | **Read By**: `nacl-tl-dev-be` (GREEN phase) | **Template**: `$(nacl-home)/nacl-tl-core/templates/impl-brief-template.md`
...
**Created By**: `nacl-tl-plan` | **Read By**: `nacl-tl-dev-fe` (GREEN phase) | **Template**: `$(nacl-home)/nacl-tl-core/templates/impl-brief-fe-template.md`
...
**Created By**: `nacl-tl-plan` | **Read By**: `nacl-tl-review` (both `--be` and `--fe`) | **Template**: `$(nacl-home)/nacl-tl-core/templates/acceptance-template.md`
...
**Created By**: `nacl-tl-plan` | **Read By**: `nacl-tl-dev-be`, `nacl-tl-dev-fe`, `nacl-tl-sync` | **Template**: `$(nacl-home)/nacl-tl-core/templates/api-contract-template.md`
...
**Created By**: `nacl-tl-dev-be` | **Read By**: `nacl-tl-review --be` | **Template**: `$(nacl-home)/nacl-tl-core/templates/result-template.md`
...
**Created By**: `nacl-tl-dev-fe` | **Read By**: `nacl-tl-review --fe` | **Template**: `$(nacl-home)/nacl-tl-core/templates/result-template.md`
...
**Created By**: `nacl-tl-review --be` | **Read By**: `nacl-tl-dev-be --continue` (if rejected) | **Template**: `$(nacl-home)/nacl-tl-core/templates/review-template.md`
...
**Created By**: `nacl-tl-review --fe` | **Read By**: `nacl-tl-dev-fe --continue` (if rejected) | **Template**: `$(nacl-home)/nacl-tl-core/templates/review-template.md`
...
**Created By**: `nacl-tl-sync` | **Read By**: `nacl-tl-full`, `nacl-tl-review` | **Template**: `$(nacl-home)/nacl-tl-core/templates/sync-report-template.md`
...
**Created By**: `nacl-tl-stubs` | **Read By**: `nacl-tl-review`, `nacl-tl-full` | **Template**: `$(nacl-home)/nacl-tl-core/templates/stub-report-template.md`
...
**Created By**: `nacl-tl-qa` | **Read By**: `nacl-tl-full`, `nacl-tl-status` | **Template**: `$(nacl-home)/nacl-tl-core/templates/qa-report-template.md`
...
**Created By**: `nacl-tl-plan` | **Read By**: `nacl-tl-dev` | **Template**: `$(nacl-home)/nacl-tl-core/templates/tech-task-template.md`
...
| File | Template Path |
|------|--------------|
| task-be.md | `$(nacl-home)/nacl-tl-core/templates/task-be-template.md` |
| task-fe.md | `$(nacl-home)/nacl-tl-core/templates/task-fe-template.md` |
| test-spec.md | `$(nacl-home)/nacl-tl-core/templates/test-spec-template.md` |
| test-spec-fe.md | `$(nacl-home)/nacl-tl-core/templates/test-spec-fe-template.md` |
| impl-brief.md | `$(nacl-home)/nacl-tl-core/templates/impl-brief-template.md` |
| impl-brief-fe.md | `$(nacl-home)/nacl-tl-core/templates/impl-brief-fe-template.md` |
| acceptance.md | `$(nacl-home)/nacl-tl-core/templates/acceptance-template.md` |
| api-contract.md | `$(nacl-home)/nacl-tl-core/templates/api-contract-template.md` |
| result-be.md / result-fe.md | `$(nacl-home)/nacl-tl-core/templates/result-template.md` |
| review-be.md / review-fe.md | `$(nacl-home)/nacl-tl-core/templates/review-template.md` |
| sync-report.md | `$(nacl-home)/nacl-tl-core/templates/sync-report-template.md` |
| stub-report.md | `$(nacl-home)/nacl-tl-core/templates/stub-report-template.md` |
| qa-report.md | `$(nacl-home)/nacl-tl-core/templates/qa-report-template.md` |
| task.md (TECH) | `$(nacl-home)/nacl-tl-core/templates/tech-task-template.md` |
