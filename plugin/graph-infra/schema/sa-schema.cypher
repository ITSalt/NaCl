...
CREATE CONSTRAINT constraint_usecase_id IF NOT EXISTS  FOR (n:UseCase) REQUIRE n.id IS UNIQUE;

CREATE CONSTRAINT constraint_activitystep_id IF NOT EXISTS  FOR (n:ActivityStep) REQUIRE n.id IS UNIQUE;

CREATE CONSTRAINT constraint_domainentity_id IF NOT EXISTS  FOR (n:DomainEntity) REQUIRE n.id IS UNIQUE;

CREATE CONSTRAINT constraint_domainattribute_id IF NOT EXISTS  FOR (n:DomainAttribute) REQUIRE n.id IS UNIQUE;

CREATE CONSTRAINT constraint_enumeration_id IF NOT EXISTS  FOR (n:Enumeration) REQUIRE n.id IS UNIQUE;

CREATE CONSTRAINT constraint_enumvalue_id IF NOT EXISTS  FOR (n:EnumValue) REQUIRE n.id IS UNIQUE;

CREATE CONSTRAINT constraint_form_id IF NOT EXISTS  FOR (n:Form) REQUIRE n.id IS UNIQUE;

CREATE CONSTRAINT constraint_formfield_id IF NOT EXISTS  FOR (n:FormField) REQUIRE n.id IS UNIQUE;

CREATE CONSTRAINT constraint_requirement_id IF NOT EXISTS  FOR (n:Requirement) REQUIRE n.id IS UNIQUE;

CREATE CONSTRAINT constraint_systemrole_id IF NOT EXISTS  FOR (n:SystemRole) REQUIRE n.id IS UNIQUE;

CREATE CONSTRAINT constraint_component_id IF NOT EXISTS  FOR (n:Component) REQUIRE n.id IS UNIQUE;

CREATE CONSTRAINT constraint_featurerequest_id IF NOT EXISTS  FOR (n:FeatureRequest) REQUIRE n.id IS UNIQUE;

CREATE CONSTRAINT constraint_decision_id IF NOT EXISTS  FOR (n:Decision) REQUIRE n.id IS UNIQUE;

CREATE CONSTRAINT constraint_screen_id IF NOT EXISTS  FOR (n:Screen) REQUIRE n.id IS UNIQUE;

CREATE CONSTRAINT constraint_screenstate_id IF NOT EXISTS  FOR (n:ScreenState) REQUIRE n.id IS UNIQUE;

CREATE CONSTRAINT constraint_screenevent_id IF NOT EXISTS  FOR (n:ScreenEvent) REQUIRE n.id IS UNIQUE;

CREATE CONSTRAINT constraint_transition_id IF NOT EXISTS  FOR (n:Transition) REQUIRE n.id IS UNIQUE;

CREATE CONSTRAINT constraint_screeneffect_id IF NOT EXISTS  FOR (n:ScreenEffect) REQUIRE n.id IS UNIQUE;

CREATE CONSTRAINT constraint_analyticsevent_id IF NOT EXISTS  FOR (n:AnalyticsEvent) REQUIRE n.id IS UNIQUE;

CREATE CONSTRAINT constraint_slice_id IF NOT EXISTS  FOR (n:Slice) REQUIRE n.id IS UNIQUE;

CREATE CONSTRAINT constraint_domainerror_id IF NOT EXISTS  FOR (n:DomainError) REQUIRE n.id IS UNIQUE;

CREATE CONSTRAINT constraint_errorpresentation_id IF NOT EXISTS  FOR (n:ErrorPresentation) REQUIRE n.id IS UNIQUE;

CREATE CONSTRAINT constraint_cachepolicy_id IF NOT EXISTS  FOR (n:CachePolicy) REQUIRE n.id IS UNIQUE;

CREATE CONSTRAINT constraint_degradationrule_id IF NOT EXISTS  FOR (n:DegradationRule) REQUIRE n.id IS UNIQUE;
...
CREATE INDEX index_module_name IF NOT EXISTS  FOR (n:Module) ON (n.name);

CREATE INDEX index_usecase_name IF NOT EXISTS  FOR (n:UseCase) ON (n.name);

CREATE INDEX index_activitystep_name IF NOT EXISTS  FOR (n:ActivityStep) ON (n.description);

CREATE INDEX index_domainentity_name IF NOT EXISTS  FOR (n:DomainEntity) ON (n.name);

CREATE INDEX index_domainentity_module IF NOT EXISTS  FOR (n:DomainEntity) ON (n.module);

CREATE INDEX index_domainattribute_name IF NOT EXISTS  FOR (n:DomainAttribute) ON (n.name);

CREATE INDEX index_enumeration_name IF NOT EXISTS  FOR (n:Enumeration) ON (n.name);

CREATE INDEX index_enumvalue_name IF NOT EXISTS  FOR (n:EnumValue) ON (n.value);

CREATE INDEX index_form_name IF NOT EXISTS  FOR (n:Form) ON (n.name);

CREATE INDEX index_formfield_name IF NOT EXISTS  FOR (n:FormField) ON (n.name);

CREATE INDEX index_requirement_name IF NOT EXISTS  FOR (n:Requirement) ON (n.description);

CREATE INDEX index_systemrole_name IF NOT EXISTS  FOR (n:SystemRole) ON (n.name);

CREATE INDEX index_component_name IF NOT EXISTS  FOR (n:Component) ON (n.name);

CREATE INDEX index_featurerequest_status IF NOT EXISTS  FOR (n:FeatureRequest) ON (n.status);

CREATE INDEX index_featurerequest_created_at IF NOT EXISTS  FOR (n:FeatureRequest) ON (n.created_at);

CREATE INDEX index_decision_status IF NOT EXISTS  FOR (n:Decision) ON (n.status);

CREATE INDEX index_decision_created_at IF NOT EXISTS  FOR (n:Decision) ON (n.created_at);

// Full-text so impact analysis / audit can find prior decisions by keyword.
CREATE FULLTEXT INDEX fulltext_decision_search IF NOT EXISTS  FOR (n:Decision) ON EACH [n.title, n.context, n.rationale];

CREATE INDEX index_screen_name IF NOT EXISTS  FOR (n:Screen) ON (n.name);

CREATE INDEX index_screenstate_kind IF NOT EXISTS  FOR (n:ScreenState) ON (n.state_kind);

CREATE INDEX index_screenevent_kind IF NOT EXISTS  FOR (n:ScreenEvent) ON (n.event_kind);

CREATE INDEX index_screeneffect_kind IF NOT EXISTS  FOR (n:ScreenEffect) ON (n.effect_kind);

CREATE INDEX index_analyticsevent_name IF NOT EXISTS  FOR (n:AnalyticsEvent) ON (n.name);

CREATE INDEX index_slice_name IF NOT EXISTS  FOR (n:Slice) ON (n.name);

CREATE INDEX index_slice_kind IF NOT EXISTS  FOR (n:Slice) ON (n.slice_kind);

CREATE INDEX index_domainerror_code IF NOT EXISTS  FOR (n:DomainError) ON (n.code);

CREATE INDEX index_domainerror_kind IF NOT EXISTS  FOR (n:DomainError) ON (n.error_kind);

CREATE INDEX index_errorpresentation_kind IF NOT EXISTS  FOR (n:ErrorPresentation) ON (n.presentation_kind);

CREATE INDEX index_cachepolicy_name IF NOT EXISTS  FOR (n:CachePolicy) ON (n.name);

CREATE INDEX index_cachepolicy_invalidation IF NOT EXISTS  FOR (n:CachePolicy) ON (n.invalidation_kind);

CREATE INDEX index_degradationrule_name IF NOT EXISTS  FOR (n:DegradationRule) ON (n.name);

CREATE INDEX index_degradationrule_trigger IF NOT EXISTS  FOR (n:DegradationRule) ON (n.trigger_kind);
