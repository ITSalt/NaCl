...
`${CLAUDE_PLUGIN_ROOT}/nacl-core/scripts/classify-findings.test.mjs`.

```bash
node ${CLAUDE_PLUGIN_ROOT}/nacl-core/scripts/classify-findings.mjs '{"layer":"ba","findings":[{"check":"L1.1","severity":"CRITICAL"},{"check":"L2.2","severity":"WARNING"}]}'
