...
See `${CLAUDE_PLUGIN_ROOT}/nacl-tl-core/references/config-schema.md` for the `project_kind`
specification.
...
See `${CLAUDE_PLUGIN_ROOT}/nacl-tl-core/references/config-schema.md` for `project_kind` and
...
4. Apply classification from `${CLAUDE_PLUGIN_ROOT}/nacl-tl-core/references/stub-tracking-rules.md`
...
Write to `review-be.md` (BE), `review-fe.md` (FE), or `review.md` (TECH) using `${CLAUDE_PLUGIN_ROOT}/nacl-tl-core/templates/review-template.md`. Include: summary, stub gate result, files reviewed, acceptance verification, checklist findings, issues, test results, TDD compliance, test author independence result, positive observations, headline + verdict, next steps.
...
Used for `--be` reviews and TECH reviews. Reference: `${CLAUDE_PLUGIN_ROOT}/nacl-tl-core/references/review-checklist.md`.
...
Used for `--fe` reviews. Reference: `${CLAUDE_PLUGIN_ROOT}/nacl-tl-core/references/fe-review-checklist.md`.
...
| Task | Reference |
|------|-----------|
| BE review checklist | `${CLAUDE_PLUGIN_ROOT}/nacl-tl-core/references/review-checklist.md` |
| FE review checklist | `${CLAUDE_PLUGIN_ROOT}/nacl-tl-core/references/fe-review-checklist.md` |
| Stub tracking | `${CLAUDE_PLUGIN_ROOT}/nacl-tl-core/references/stub-tracking-rules.md` |
| Code style (BE) | `${CLAUDE_PLUGIN_ROOT}/nacl-tl-core/references/code-style.md` |
...
- `${CLAUDE_PLUGIN_ROOT}/nacl-tl-core/templates/review-template.md` -- Review result template
