...
`NACL_DEVELOPER_ID="$(node ${CLAUDE_PLUGIN_ROOT}/nacl-core/scripts/resolve-developer-id.mjs --project-root .)"` (auto
...
holds it — skip to the next candidate. See `${CLAUDE_PLUGIN_ROOT}/nacl-tl-core/references/remote-mode-coordination.md`.
...
| Context | Reference |
|---------|-----------|
| Protocol and agent contracts | `${CLAUDE_PLUGIN_ROOT}/nacl-tl-core/references/tl-protocol.md` |
| Sync verification rules | `${CLAUDE_PLUGIN_ROOT}/nacl-tl-core/references/sync-rules.md` |
| Stub tracking rules | `${CLAUDE_PLUGIN_ROOT}/nacl-tl-core/references/stub-tracking-rules.md` |
| QA testing rules | `${CLAUDE_PLUGIN_ROOT}/nacl-tl-core/references/qa-rules.md` |
