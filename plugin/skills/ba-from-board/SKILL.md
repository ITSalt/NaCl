...
**You DO read:** `${CLAUDE_PLUGIN_ROOT}/nacl-core/SKILL.md` --- shared Excalidraw format, customData, colors, layout, ID rules.
...
4. **Generate an empty board** with a swimlane scaffold per `${CLAUDE_PLUGIN_ROOT}/nacl-core/SKILL.md` templates.
...
- `${CLAUDE_PLUGIN_ROOT}/nacl-core/SKILL.md`, sub-skill SKILL.md files (on demand)
