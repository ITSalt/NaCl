...
`${CLAUDE_PLUGIN_ROOT}/nacl-tl-core/references/remote-mode-coordination.md`.
...
| TL protocol and agent contracts | `${CLAUDE_PLUGIN_ROOT}/nacl-tl-core/references/tl-protocol.md` |
| Stub tracking rules | `${CLAUDE_PLUGIN_ROOT}/nacl-tl-core/references/stub-tracking-rules.md` |
| QA rules and process | `${CLAUDE_PLUGIN_ROOT}/nacl-tl-core/references/qa-rules.md` |
