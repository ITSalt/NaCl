...
**CRITICAL**: All task files must be **self-sufficient**. Development agents (`tl-dev-be`, `tl-dev-fe`, `tl-dev`) read ONLY files in `.tl/tasks/{ID}/` -- never the original SA artifacts in `docs/`. Every piece of information needed for development must be embedded directly in the task files.
...
|-------|--------------|----------|
| Planning | task-be, task-fe, test-spec, test-spec-fe, impl-brief, impl-brief-fe, acceptance, api-contract | tl-plan |
| BE Development | result-be | tl-dev-be |
| FE Development | result-fe | tl-dev-fe |
| BE Review | review-be | tl-review --be |
| FE Review | review-fe | tl-review --fe |
| Sync Check | sync-report | tl-sync |
| Stub Scan | stub-report | tl-stubs |
| QA Testing | qa-report | tl-qa |
...
**Created By**: `tl-plan` | **Read By**: `tl-dev-be` | **Template**: `tl-core/templates/task-be-template.md`
...
**Created By**: `tl-plan` | **Read By**: `tl-dev-fe` | **Template**: `tl-core/templates/task-fe-template.md`
...
**Purpose**: Defines all backend test cases for TDD development. The `tl-dev-be` agent writes tests based on this specification BEFORE writing implementation code (RED phase).

**Created By**: `tl-plan` | **Read By**: `tl-dev-be` (RED phase) | **Template**: `tl-core/templates/test-spec-template.md`
...
**Created By**: `tl-plan` | **Read By**: `tl-dev-fe` (RED phase) | **Template**: `tl-core/templates/test-spec-fe-template.md`
...
**Created By**: `tl-plan` | **Read By**: `tl-dev-be` (GREEN phase) | **Template**: `tl-core/templates/impl-brief-template.md`
...
**Created By**: `tl-plan` | **Read By**: `tl-dev-fe` (GREEN phase) | **Template**: `tl-core/templates/impl-brief-fe-template.md`
...
**Created By**: `tl-plan` | **Read By**: `tl-review` (both `--be` and `--fe`) | **Template**: `tl-core/templates/acceptance-template.md`
...
**Created By**: `tl-plan` | **Read By**: `tl-dev-be`, `tl-dev-fe`, `tl-sync` | **Template**: `tl-core/templates/api-contract-template.md`
...
**Created By**: `tl-dev-be` | **Read By**: `tl-review --be` | **Template**: `tl-core/templates/result-template.md`
...
**Created By**: `tl-dev-fe` | **Read By**: `tl-review --fe` | **Template**: `tl-core/templates/result-template.md`
...
**Created By**: `tl-review --be` | **Read By**: `tl-dev-be --continue` (if rejected) | **Template**: `tl-core/templates/review-template.md`
...
**Created By**: `tl-review --fe` | **Read By**: `tl-dev-fe --continue` (if rejected) | **Template**: `tl-core/templates/review-template.md`
...
**Created By**: `tl-sync` | **Read By**: `tl-full`, `tl-review` | **Template**: `tl-core/templates/sync-report-template.md`
...
**Created By**: `tl-stubs` | **Read By**: `tl-review`, `tl-full` | **Template**: `tl-core/templates/stub-report-template.md`
...
**Created By**: `tl-qa` | **Read By**: `tl-full`, `tl-status` | **Template**: `tl-core/templates/qa-report-template.md`
...
**Created By**: `tl-plan` | **Read By**: `tl-dev` | **Template**: `tl-core/templates/tech-task-template.md`
...
```
tl-plan creates all planning files
    |
    v
BE: tl-dev-be --> tl-stubs --> tl-review --be
    |                              |
    |                   +----------+----------+
    |                   |                     |
    |               APPROVED              REJECTED
    |                   |                     |
    |                   v                     v
    |              (continue)       tl-dev-be --continue --> re-review
    |
    v (after BE approved)
FE: tl-dev-fe --> tl-stubs --> tl-review --fe
    |                              |
    |                   +----------+----------+
    |                   |                     |
    |               APPROVED              REJECTED
    |                   |                     |
    |                   v                     v
    |              (continue)       tl-dev-fe --continue --> re-review
    |
    v (after both BE and FE approved)
tl-sync --> tl-stubs (final) --> tl-qa --> DONE
```

### Simplified Flow

```
tl-plan creates files
    |
BE: tl-dev-be --> tl-review --be --> (if rejected --> tl-dev-be --continue --> re-review)
    |
FE: tl-dev-fe --> tl-review --fe --> (if rejected --> tl-dev-fe --continue --> re-review)
    |
tl-sync --> tl-stubs --> tl-qa --> DONE
```

### TECH Task Lifecycle

```
tl-plan --> tl-dev --> tl-stubs --> tl-review --be --> (APPROVED --> tl-docs --> DONE)
                                                  --> (REJECTED --> tl-dev --continue)
```
...
- **SYNC after pairs**: tl-sync runs when both BE and FE for a UC are approved
...
| File | Template Path |
|------|--------------|
| task-be.md | `tl-core/templates/task-be-template.md` |
| task-fe.md | `tl-core/templates/task-fe-template.md` |
| test-spec.md | `tl-core/templates/test-spec-template.md` |
| test-spec-fe.md | `tl-core/templates/test-spec-fe-template.md` |
| impl-brief.md | `tl-core/templates/impl-brief-template.md` |
| impl-brief-fe.md | `tl-core/templates/impl-brief-fe-template.md` |
| acceptance.md | `tl-core/templates/acceptance-template.md` |
| api-contract.md | `tl-core/templates/api-contract-template.md` |
| result-be.md / result-fe.md | `tl-core/templates/result-template.md` |
| review-be.md / review-fe.md | `tl-core/templates/review-template.md` |
| sync-report.md | `tl-core/templates/sync-report-template.md` |
| stub-report.md | `tl-core/templates/stub-report-template.md` |
| qa-report.md | `tl-core/templates/qa-report-template.md` |
| task.md (TECH) | `tl-core/templates/tech-task-template.md` |
