...
This example demonstrates the complete end-to-end workflow using all TL skills: `tl-plan` -> `tl-dev` -> `tl-review` -> `tl-docs`. We follow the implementation of UC001 (Create Order) through all phases.
...
## Phase 2: Development (`tl-dev UC001`)
...
## Phase 3: Code Review (`tl-review UC001`)

### 3.1 Trigger

```
User: /tl-review UC001
```
...
- **14:30** - UC001 Create Order - Review completed
  ...
  - Blocking issues: 0
  - Status: approved
  - Generated by: tl-review
```

---

## Phase 4: Documentation (`tl-docs UC001`)
...
```
10:00  [tl-plan]   Development plan created
                   - 10 tasks identified
                   - Dependencies mapped
                   - .tl/ structure created

10:30  [tl-dev]    UC001 development started
                   - Status: in_progress

10:30  [tl-dev]    RED phase
       - 10:45     - Tests written, all failing

10:45  [tl-dev]    GREEN phase
       - 11:30     - Implementation completed
                   - All tests passing

11:30  [tl-dev]    REFACTOR phase
       - 12:00     - Code improved
                   - Tests still passing

12:00  [tl-dev]    UC001 development completed
                   - Status: ready_for_review
                   - result.md created

14:00  [tl-review] UC001 review started
                   - Status: in_review

14:30  [tl-review] UC001 review completed
                   - 12/12 criteria passed
                   - 2 issues found & resolved
                   - Status: approved
                   - review.md created

15:00  [tl-docs]   UC001 documentation completed
                   - API docs updated
                   - README updated
                   - Status: done

15:00  [tl-status] Current project status:
                   - Done: 1/10 (10%)
...
If `tl-review` finds blocking issues:
...
```
/tl-dev UC001  # Developer fixes issues
/tl-review UC001  # Re-review
```
