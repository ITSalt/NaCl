...
All TL skills (`tl-plan`, `tl-dev`, `tl-review`, `tl-docs`)
...
|-------|-------------|-------|
| PLAN | Task planning and preparation | tl-plan |
| DEV | Development work (TDD cycle) | tl-dev |
| REVIEW | Code review | tl-review |
| DOCS | Documentation updates | tl-docs |
