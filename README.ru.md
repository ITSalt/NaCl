...
Neo4j будет доступен на `localhost:7474`.

**3. Установите скиллы для вашей агентской среды**
...
NaCl/
  ...
  graph-infra/        Docker-инфраструктура Neo4j
...
| [docs/skills-reference.md](docs/skills-reference.md) | Полный каталог всех 57 скиллов с параметрами и примерами |
