...
```
/tl-release                       # auto-detect version bump from changelog
/tl-release --minor               # force minor version bump
/tl-release --major               # force major version bump
/tl-release --patch               # force patch version bump
```
