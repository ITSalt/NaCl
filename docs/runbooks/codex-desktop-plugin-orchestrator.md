...
Integration SHA: 93084dd (accepted Wave 9 ADR, reconciliation plan, and reconciled runbook on fresh main d828e54); Waves 0-7 VERIFIED; Wave 8 PARTIALLY_VERIFIED; Wave 9 local implementation IN_PROGRESS
...
| 9 — Full app-plus-skills production readiness | IN_PROGRESS / LOCAL_IMPLEMENTATION_AUTHORIZED | `codex/plugin-09-mainline-integration` / `93084dd` planning baseline | `docs/adr/004-codex-production-app.md`; `docs/research/codex-plugin-wave-9-main-reconciliation-2026-07-15.md`; reconciled Wave 9 in this runbook; independent architecture/runbook review `ACCEPT`; fresh base `main=origin/main=d828e54` | Local/provider-neutral source, tests, fixtures, security documentation and package reconciliation are authorized. VPS/DNS/certificates/credentials/paid resources/deploy/portal/push/PR/main merge/tag/release remain `NOT_AUTHORIZED`; frozen Git-release portability and hosted/production evidence remain mandatory before aggregate `VERIFIED`; skills-only fallback prohibited |
