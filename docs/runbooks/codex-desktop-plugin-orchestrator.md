...
Integration branch: codex/desktop-plugin-integration
Integration worktree: /Users/maxnikitin/projects/NaCl-codex-desktop
Integration SHA: 4ea3a1e (exact Wave 8 documentation candidate merged for private-share trial); Waves 0-7 VERIFIED; Wave 8 PARTIALLY_VERIFIED
...
| 8 — Plugin-first documentation | PARTIALLY_VERIFIED | `codex/plugin-08-documentation` / `5b18834f750d462c4b010da8ea1e249ed54a4ee8`; merged by `4ea3a1e`; cachebuster candidate `2dd21a7` | `docs/research/codex-plugin-wave-8-documentation-2026-07-15.md`; independent `ACCEPT DOCUMENTS / PARTIALLY_VERIFIED`; 32 RU/EN Markdown documents; exact 10 public skills, 60 workflows, and 25 MCP tools; docs tests 9/9; package 83/83; closure 357 files; contracts 329 passed, 5 authorized Docker skips, 0 failed; Pandoc 32/32; manifest, frozen 62 roots, root sync, bundled mirror, and final integration gates `VERIFIED` after two correction rounds | Private share card/link, clean-account UI install, permissions, full restart/new task, exact-version installation doctor, first-run dry-run, update/reinstall/disable/enable/uninstall/rollback, and sanitized screenshots are `NOT_RUN`; exact Node 20 and live Keychain graph bootstrap remain deferred; Wave 9 is blocked until the live novice journey is accepted |
| 9 — Full app-plus-skills production readiness | NOT_RUN | — | Planned production Streamable HTTP MCP, auth/domain/CSP, remote isolation/revoke/restore, legal/publisher assets, complete tool annotations, reviewer fixtures, hosted security/CI/SBOM matrix, and frozen full submission bundle | Blocked on Wave 8 `VERIFIED` plus separate infrastructure, credential, cost, security, and deployment authorization; skills-only fallback prohibited |
