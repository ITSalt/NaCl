...
Skills-only implementation: a2ed3f6688ec6374e401d29b1fdba8b82050bc5a; independent ACCEPT; hosted Linux/Docker and native Windows VERIFIED; Wave 9 RELEASE_READY
...
| 9 — Bootstrap-first Skills-only production readiness | VERIFIED / RELEASE_READY | `codex/plugin-skills-only-bootstrap` / `a2ed3f6688ec6374e401d29b1fdba8b82050bc5a` | ADR-005; independent final `ACCEPT`; 282 contracts: 275 pass/7 authorized skips/0 fail; exact staged-tree Docker bootstrap, repeat run, mandatory restart, new-process MCP handshake/tools/schema/named read/confirmed write/read-back; hosted primary `29748211962`, exact native Windows `29748211921`, lint/credential `29748211898`, and generic tools `29748211900` successful; deterministic pre-freeze ZIP built twice byte-identically: 158 entries, 465529 bytes, SHA-256 `029fc7394de464faecc755e6ee53098feaec4c4db0bdb0c45daf129b33853b01`; 10 self-contained public skills; publisher/legal/support metadata bound to ITSalt | Final ZIP must be rebuilt from the exact merged main SHA, tagged, attached to the GitHub Release, and uploaded unchanged. Live portal validation, reviewer execution in the OpenAI environment, directory install/update/uninstall, review outcome, and publication remain Wave 10. No public MCP, OAuth, hosted data plane, or second Git installation is part of the product |
...
| 2026-07-20 | Wave 9 Skills-only acceptance | Accept exact implementation `a2ed3f6688ec6374e401d29b1fdba8b82050bc5a` as `VERIFIED / RELEASE_READY` and authorize the merge/release handoff to Wave 10. | Independent re-review returned `ACCEPT` after closing runtime-drifting reviewer fixtures, canonical-root alias acceptance, the impossible checksum fixture, Windows ACL ownership, and the repository credential-lint false positive without weakening the scan. Full local contracts, real staged-tree Docker/MCP E2E, exact hosted Linux/Docker, exact native Windows, deterministic ZIP, closure, legal metadata, privacy, secret scan, validator, and Claude isolation all passed. Portal upload/reviewer execution/submission/publication remain separate Wave 10 gates. |

### Candidate handoff

```text
Status: VERIFIED / RELEASE_READY — Wave 10 portal draft pending
Accepted implementation SHA: a2ed3f6688ec6374e401d29b1fdba8b82050bc5a
