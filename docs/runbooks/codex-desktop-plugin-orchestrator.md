...
Integration SHA: e220031 (independently accepted Wave 9 Stage 1 on fresh main d828e54); Waves 0-7 VERIFIED; Wave 8 PARTIALLY_VERIFIED; Wave 9 IN_PROGRESS with Stage 1 PARTIALLY_VERIFIED
...
| 9 — Full app-plus-skills production readiness | IN_PROGRESS / LOCAL_IMPLEMENTATION_AUTHORIZED | `codex/plugin-09-mainline-integration` / `e220031`; Stage 1 `PARTIALLY_VERIFIED` | `docs/adr/004-codex-production-app.md`; `docs/research/codex-plugin-wave-9-main-reconciliation-2026-07-15.md`; `docs/research/codex-plugin-wave-9-stage-1-import-2026-07-15.md`; reconciled Wave 9 in this runbook; independent architecture/runbook and final Stage 1 reviews `ACCEPT`; fresh base `main=origin/main=d828e54`; exact 421 additions, 0 deletions/base modifications, strict personal/temp scan, Claude tree parity | Stage 2 must rebuild the provisional 357-file seed from current main and close server-wide authorization, full create/connect route parity, safe Cypher, unique ports, legacy validator, package 76/83, workflow 35/38 and documentation failures. VPS/DNS/certificates/credentials/paid resources/deploy/portal/push/PR/main merge/tag/release remain `NOT_AUTHORIZED`; frozen Git-release portability and hosted/production evidence remain mandatory before aggregate `VERIFIED`; skills-only fallback prohibited |
