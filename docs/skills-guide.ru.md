...
Используйте `/nacl-goal`, когда нужен автономный цикл по алиасу вместо ручного запуска
скиллов. Команда оборачивает `/goal` от Anthropic принудительным соблюдением ворот NaCl
