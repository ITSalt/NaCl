...
Запускать все 55 скиллов на Opus -- расточительство бюджета на задачах, с которыми Sonnet справляется одинаково хорошо. Запускать всё на Haiku -- потеря качества там, где важны рассуждения. Архитектура агентов маршрутизирует каждый скилл на правильную модель.
