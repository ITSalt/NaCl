[Home](../../README.md) > [Docs](../architecture.md) > Methodology

# NaCl Methodology

How and why NaCl organizes business analysis, system analysis, and development into a graph-backed pipeline.

## Documents

| Document | Description |
|----------|-------------|
| [Overview](overview.md) | Three layers, one graph, the autonomy principle |
