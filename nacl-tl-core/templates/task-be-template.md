...
Located in: `.tl/tasks/{{task_id}}/task-be.md`

Example: `.tl/tasks/UC001/task-be.md`

## Purpose

The backend task description file. Contains ALL information needed to understand WHAT to implement on the **backend**: API endpoints, services, business logic, database operations. This file must be **self-sufficient** — the development agent reads ONLY this file, never the original SA artifacts.

For frontend implementation, see the paired file `task-fe.md`.
