...
2. L0 launches: `Launch Task agent: /nacl-ba-[skill] [mode]`
...
### Phase 1: System Context -> `/nacl-ba-context`

**Launch:** `Launch Task agent: /nacl-ba-context full`
...
### Phase 2: Business Processes -> `/nacl-ba-process`

**Launch:** `Launch Task agent: /nacl-ba-process full`
...
### Phase 3: Workflows -> `/nacl-ba-workflow` (per BP with has_decomposition=true)
...
### Phase 4: Business Entities -> `/nacl-ba-entities`

**Launch:** `Launch Task agent: /nacl-ba-entities full`
...
### Phase 5: Business Roles -> `/nacl-ba-roles`

**Launch:** `Launch Task agent: /nacl-ba-roles full`
...
### Phase 6: Glossary -> `/nacl-ba-glossary`

**Launch:** `Launch Task agent: /nacl-ba-glossary full`
...
### Phase 7: Business Rules -> `/nacl-ba-rules`

**Launch:** `Launch Task agent: /nacl-ba-rules full`
...
### Phase 8: Validation -> `/nacl-ba-validate`

**Launch:** `Launch Task agent: /nacl-ba-validate internal`
...
### Phase 9: BA->SA Handoff -> `/nacl-ba-handoff`

**Launch:** `Launch Task agent: /nacl-ba-handoff full`
...
### Phase 10: Publish (optional) -> `/nacl-publish`
...
5. Return to open questions in Phase 8 (nacl-ba-validate) --- validation will catch gaps
...
### Orchestration
- [ ] Phase 1: nacl-ba-context completed and confirmed
- [ ] Phase 2: nacl-ba-process completed and confirmed
- [ ] Phase 3: nacl-ba-workflow completed for all BPs with has_decomposition=true
- [ ] Phase 4: nacl-ba-entities completed and confirmed
- [ ] Phase 5: nacl-ba-roles completed and confirmed
- [ ] Phase 6: nacl-ba-glossary completed and confirmed
- [ ] Phase 7: nacl-ba-rules completed and confirmed
- [ ] Phase 8: nacl-ba-validate passed (0 critical errors)
- [ ] Phase 9: nacl-ba-handoff completed and confirmed
- [ ] Phase 10: nacl-publish executed (if user confirmed)
